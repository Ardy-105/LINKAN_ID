...
<body>
    ...
    <div class="content">
        <h2>Edit Theme</h2>
        <form action="{{ route('platformadmin.theme.update', $theme->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                @if($theme->preview_image)
                    <img src="{{ asset('storage/' . $theme->preview_image) }}" width="100"><br>
                @endif
            ...
            <div class="mb-3">
                ...
                @if($theme->background_image)
                    <img src="{{ asset('storage/' . $theme->background_image) }}" width="100"><br>
                @endif
