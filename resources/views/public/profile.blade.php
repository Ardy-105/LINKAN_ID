...
<head>
    ...
    background-image: url('{{ ($appearance && $appearance->background_color) ? asset('storage/themes/backgrounds/' . $appearance->background_color) . '?v=' . time() : asset('images/background.png') }}');
...
<body>
    <div class="content-wrapper" style="background: {{ ($appearance && $appearance->background_color) ? 'url(' . asset('storage/themes/backgrounds/' . $appearance->background_color) . ')' : '#fff' }}; background-size: cover; background-position: center;">
