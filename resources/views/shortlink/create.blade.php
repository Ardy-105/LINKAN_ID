        ...
        <div class="main-content">
            ...
            <div class="modern-card shortlink-history-container">
                ...
                <table class="shortlink-history-table" id="shortlinkHistoryTable">
                    ...
                    <tbody>
                        @foreach($shortlinks as $i => $shortlink)
                        <tr>
                ...
                <div class="pagination-wrapper" style="margin-top: 18px; display: flex; justify-content: center;">
                    @if ($shortlinks->lastPage() > 1)
                        <div class="pagination-links" style="display: flex; gap: 6px; align-items: center; flex-wrap: wrap;">
                            ...
                            @else
                                <a href="{{ $shortlinks->previousPageUrl() }}" class="pagination-link" style="padding: 8px 14px; background: #FF9040; color: #fff; border-radius: 6px; text-decoration: none; font-weight:700;">Previous</a>
                            @endif

                            {{-- Nomor Halaman --}}
                            @for ($i = 1; $i <= $shortlinks->lastPage(); $i++)
                                @if ($i == $shortlinks->currentPage())
                                    <span class="pagination-current" style="padding: 8px 14px; background: #181818; color: #fff; border-radius: 6px; font-weight:700;">{{ $i }}</span>
                                @else
                                    <a href="{{ $shortlinks->url($i) }}" class="pagination-link" style="padding: 8px 14px; background: #fff; color: #FF9040; border-radius: 6px; text-decoration: none; font-weight:700; border:1.5px solid #FF9040;">{{ $i }}</a>
                                @endif
                            @endfor

                            {{-- Tombol Next --}}
                            @if ($shortlinks->hasMorePages())
                                <a href="{{ $shortlinks->nextPageUrl() }}" class="pagination-link" style="padding: 8px 14px; background: #FF9040; color: #fff; border-radius: 6px; text-decoration: none; font-weight:700;">Next</a>
                            @else
