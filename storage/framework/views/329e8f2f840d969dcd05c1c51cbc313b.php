...
<body>
    ...
    <div class="content">
        <h2>Tambah Theme</h2>
        <form action="<?php echo e(route('platformadmin.theme.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
</html> <?php /**PATH C:\LINKAN_ID\resources\views/platformadmin/theme/create.blade.php ENDPATH**/ ?>