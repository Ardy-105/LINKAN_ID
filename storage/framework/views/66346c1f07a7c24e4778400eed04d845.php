...
<html>
<head>
    <title>Edit Theme - Admin Platform</title>
...
<body>
    ...
    <div class="content">
        <h2>Edit Theme</h2>
        <form action="<?php echo e(route('platformadmin.theme.update', $theme->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="mb-3">
                <label for="name" class="form-label">Nama Theme</label>
                <input type="text" name="name" class="form-control" value="<?php echo e($theme->name); ?>" required>
            </div>
            <div class="mb-3">
                <label for="preview_image" class="form-label">Preview Image</label><br>
                <?php if($theme->preview_image): ?>
                    <img src="<?php echo e(asset('storage/' . $theme->preview_image)); ?>" width="100"><br>
                <?php endif; ?>
                <input type="file" name="preview_image" class="form-control">
                <small>Kosongkan jika tidak ingin mengganti</small>
            </div>
            <div class="mb-3">
                <label for="background_image" class="form-label">Background Image</label><br>
                <?php if($theme->background_image): ?>
                    <img src="<?php echo e(asset('storage/' . $theme->background_image)); ?>" width="100"><br>
                <?php endif; ?>
                <input type="file" name="background_image" class="form-control">
                <small>Kosongkan jika tidak ingin mengganti</small>
            </div>
            <button type="submit" class="btn btn-primary">Update</button>
            <a href="<?php echo e(route('platformadmin.theme.index')); ?>" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
</body>
</html> <?php /**PATH C:\LINKAN_ID\resources\views/platformadmin/theme/edit.blade.php ENDPATH**/ ?>