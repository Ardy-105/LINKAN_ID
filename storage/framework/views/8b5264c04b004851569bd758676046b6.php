...
<main class="hero">
        ...
        <div class="hero-image" id="heroImage">
            <div class="phone-mockup">
                <img src="<?php echo e(asset('images/service.png')); ?>" alt="Mobile App Preview">
            </div>
        </div>
</main>
</body>
</html>
<?php echo $__env->make('layout.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Ardy\2025\Semester 4\Project2\LINKAN_ID-finalproject\resources\views/service.blade.php ENDPATH**/ ?>