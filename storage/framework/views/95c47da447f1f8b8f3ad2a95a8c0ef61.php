...
<div class="register-main-container">
    <div class="register-illustration">
        <img src="<?php echo e(asset('images/Singing Contract.png')); ?>" alt="Register Illustration" />
    </div>
            ...
            <div class="register-card-body">
                ...
                <form method="POST" action="<?php echo e(route('register.submit')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" placeholder="Example@gmail.com" value="<?php echo e($googleData['email'] ?? old('email')); ?>" required>
                    </div>
                    <div class="form-group">
...
</html><?php /**PATH C:\Ardy\2025\Semester 4\Project2\LINKAN_ID-finalproject\resources\views/register.blade.php ENDPATH**/ ?>