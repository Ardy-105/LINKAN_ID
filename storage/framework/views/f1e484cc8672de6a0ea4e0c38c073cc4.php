...
<body>
    ...
    <div class="max-w-2xl mx-auto p-8 mt-20 bg-white shadow-lg rounded-xl relative">
        <!-- Close button -->
        <a href="<?php echo e(url('/')); ?>" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 text-xl font-bold">
            &times;
        </a>
...
<?php /**PATH C:\Ardy\2025\Semester 4\Project2\LINKAN_ID-finalproject\resources\views/contact.blade.php ENDPATH**/ ?>